...
### Message Queue
- Build a rotation of items: text messages, saved messages, clock, or weather
...
board size, alignment, sound, clock format, weather location/unit, saved messages, and queue contents.
